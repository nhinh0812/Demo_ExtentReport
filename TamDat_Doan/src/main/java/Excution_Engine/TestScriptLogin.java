...
//	static ExtentManager test;
//	static ExtentTestManager report;
...
//		test = report.startTest("ExtentDemo");
	...
	public void excute_TestCaseDangNhap() throws Exception {
		Log.info("===========Chạy testcase Đăng nhập===========");

		String sPath = System.getProperty("user.dir") + "//src//main//java//Data_Engine//Data_Login.xlsx";
		ExcelUtils.setExcelFile(sPath, "Login");
		int CasePass = 0;
		int CaseFail = 0;
		int CaseSkip = 0;
		for (int iRow = 1; iRow <= ExcelUtils.getRowCount("Login"); iRow++) {
